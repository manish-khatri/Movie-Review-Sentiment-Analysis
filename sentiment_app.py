...
st.markdown("---")
st.sidebar.title("Sample Reviews")
st.sidebar.markdown("Here are some sample reviews, you can copy-paste them.")
...
st.sidebar.markdown(pathaan_review)
st.sidebar.markdown(oppenheimer_review)
